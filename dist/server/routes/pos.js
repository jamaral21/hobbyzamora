...
// Create POS sale
router.post('/sale', authenticate, requireRole('ADMIN', 'STAFF'), async (req, res) => {
    try {
        const { items, customerName = 'Walk-in Customer', customerEmail = '', customerPhone = '', paymentMethod, amountPaid, notes, } = req.body;
