...
import { PRODUCT_CATEGORY_OPTIONS, buildSkuFromCategory, isAutoGeneratedSku, isOfficialStoreCategory, normalizeStoreCategory } from '../../lib/sku';
...
export function ProductEditor({
  ...
  const hasLegacyCategory = Boolean(formData.category && !isOfficialStoreCategory(String(formData.category)));
