...
import { Search, Barcode, Grid, List, Loader2 } from 'lucide-react';
...
import { usePOSProducts, useMutation } from '../../hooks/useData';
  ...
  const handlePayment = async (method: PaymentMethod) => {
    try {
      await createSale.mutateAsync({
        ...
        cashierId: undefined // Will use current user from auth
      });
      setCartItems([]);
