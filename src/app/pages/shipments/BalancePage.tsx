    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center pt-2 border-t border-border">
              ...
              <PriceDisplay amount={balance.activos} currency="CLP" className="font-bold text-emerald-600" />
            </div>
          </div>
        </Card>
        ...
        <div className="space-y-6">
          ...
          <Card className={`border-2 ${balance.patrimonio >= 0 ? 'border-emerald-300 bg-emerald-50' : 'border-destructive/30 bg-destructive/5'}`}>
            <div className="flex justify-between items-center">
              ...
              <PriceDisplay
                ...
                currency="CLP"
                className={`text-xl font-bold ${balance.patrimonio >= 0 ? 'text-emerald-600' : 'text-destructive'}`}
              />
            </div>
